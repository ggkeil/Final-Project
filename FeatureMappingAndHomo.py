...
# crop() exists to get rid of the black around the stitched image.
def crop(stitched):
...
cv2.namedWindow('After Cropping', cv2.WINDOW_NORMAL )
...
if ans == 'y':
    ...
    cv2.namedWindow('After Equalization', cv2.WINDOW_KEEPRATIO)
